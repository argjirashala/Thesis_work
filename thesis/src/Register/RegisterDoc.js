...
function RegisterDoc() {
  ...
  const handleSubmit = async (e) => {
    ...
    const emailExists =
      (await (
        await getDocs(
          query(collection(db, "doctors"), where("email", "==", formData.email))
        )
      ).size) > 0;
    ...
    try {
      ...
      setErrors([
        "If you are already a patient trying to register as a doctor please use a different email address",
      ]);
    }
  };
            ...
            <div className="register forms form-style">
              ...
              <label>
                ...
                >
                  ...
                  <option value="Dietitian/Dietician">
                    Dietitian/Dietician
                  </option>
                  ...
                  <option value="Hyperbarichysician">
